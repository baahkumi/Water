...
Contributors to the model
    ...
    Bernard Baah-Kumi (PhD student-Water Science and Management Program)
    New Mexico State University, Las Cruces, NM USA

    updated July 10, 2020

IDEA: Optimize the basin for now with - flood control and economic development policy of building
      two new additional dams with a prospective water and power trade agreement for the basin
**************** Section 1 ***********************************************************************
...
/     01_Samen_v_f       guage at Samendeni on Black Volta in west Burkina Faso
      ...
      16_Prang_v_f       guage at Prang on the Pru river in Ghana tributary of Lower Volta
      17_Ekumdipe_v_f    guage at Eumdipe on Daka river in Ghana tributary of Lower Volta
...
KPONG_rel_f
*---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
+               11_Nangodi_v_f    12_Pwalugu_v_f    13_Nawuni_v_f    14_Bamboi_v_f    15_Sabari_v_f    16_Prang_v_f   17_Ekumdipe_v_f   18_AkosomUp_v_f    19_Senchi_v_f    20_Kpong_v_f
* ----------------headwater inflow node rows (+) ---------------------------------------------------------------------------------------------------------------------------------------
BVSame_h_f
Sorou_h_f
Nwok_h_f
...
* TRY OUT THIS CONSTRAINT TO PROVE TO REVIEWERS THAT TOTAL ECONOMIC WELFARE IS BETTER WITH THE TREATY THAN WITHOUT IT
...
check_wat_stock_p ('09_TANOSO_res_s',t,k,s,m,p)$[(ord(k) * ord(t)) gt 1]  =  X_v.l('Pru_h_f',t,k,s,m,p)- X_v.l('16_Prang_v_f',t,k,s,m,p)- X_v.l('TanosoAg_d_f',t,k,s,m,p)-X_v.l('AkumaAg_d_f',t,k,s,m,p)
...
check_wat_stock_p ('11_SUBIN_res_s',t,k,s,m,p) $ [(ord(k) * ord(t)) gt 1]   = X_v.l ('Subin_h_f',t,k,s,m,p)+ X_v.l('Mo_h_f',t,k,s,m,p)+ X_v.l('Mole_h_f',t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',t,k,s,m,p)+ X_v.l('14_Bamboi_v_f',t,k,s,m,p)+ X_v.l('15_Sabari_v_f',t,k,s,m,p)
                                                              + X_v.l('16_Prang_v_f',t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p) - X_v.l('18_AkosomUp_v_f',t,k,s,m,p)- X_v.l('SubinjAg_d_f',t,k,s,m,p)- X_v.l('DipaliAg_d_f',t,k,s,m,p)- X_v.l('SogoAg_d_f',t,k,s,m,p)
...
check_wat_use_p('SubinjAg_u_f',t,k,s,m,p)= X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('Mole_h_f',       t,k,s,m,p)+ X_v.l('Mo_h_f',      t,k,s,m,p) + X_v.l('13_Nawuni_v_f',  t,k,s,m,p)+ X_v.l('14_Bamboi_v_f',t,k,s,m,p)
                                         + X_v.l('15_Sabari_v_f',t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)+ X_v.l('16_Prang_v_f',t,k,s,m,p) - X_v.l('18_AkosomUp_v_f',t,k,s,m,p)- X_v.l('DipaliAg_d_f', t,k,s,m,p)
...
check_wat_use_p('DipaliAg_u_f',t,k,s,m,p)= X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('Mole_h_f',       t,k,s,m,p)+ X_v.l('Mo_h_f',      t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',   t,k,s,m,p)+ X_v.l('14_Bamboi_v_f',t,k,s,m,p)
                                         + X_v.l('15_Sabari_v_f',t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)+ X_v.l('16_Prang_v_f',t,k,s,m,p)- X_v.l('18_AkosomUp_v_f', t,k,s,m,p)- X_v.l('SubinjAg_d_f', t,k,s,m,p)
                                         - X_v.l('SogoAg_d_f',   t,k,s,m,p)- X_v.l('LibgaAg_d_f',    t,k,s,m,p)- X_v.l('SavelUr_d_f', t,k,s,m,p)- X_v.l('GolgaAg_d_f',     t,k,s,m,p)- X_v.l('BotangAg_d_f', t,k,s,m,p)
                                         - X_v.l('DaboAg_d_f',   t,k,s,m,p)- X_v.l('TamaleUr_d_f',   t,k,s,m,p)- X_v.l('YapeiAg_d_f', t,k,s,m,p)- X_v.l('NewLoAg_d_f',     t,k,s,m,p)- X_v.l('AsanKAg_d_f',  t,k,s,m,p)
...
*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('SavelUr_u_f',t,k,s,m,p) = X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',  t,k,s,m,p)+ X_v.l('14_Bamboi_v_f',t,k,s,m,p)+ X_v.l('15_Sabari_v_f',  t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         ...
                                         + X_v.l('AsanKAg_r_f',  t,k,s,m,p)- X_v.l('NewLoAg_d_f',    t,k,s,m,p)- X_v.l('AsanKAg_d_f',  t,k,s,m,p)+ X_v.l('16_Prang_v_f',   t,k,s,m,p)- X_v.l('18_AkosomUp_v_f',t,k,s,m,p)
...
*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('GolgaAg_u_f',t,k,s,m,p) = X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',  t,k,s,m,p)+ X_v.l('14_Bamboi_v_f',t,k,s,m,p) + X_v.l('15_Sabari_v_f', t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         ...
                                         - X_v.l('AsanKAg_d_f',  t,k,s,m,p)+ X_v.l('16_Prang_v_f',   t,k,s,m,p)- X_v.l('LibgaAg_d_f', t,k,s,m,p) + X_v.l('BuipeAg_r_f',   t,k,s,m,p)- X_v.l('DaboAg_d_f',     t,k,s,m,p)
...
*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('BotangAg_u_f',t,k,s,m,p)= X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',t,k,s,m,p) + X_v.l('14_Bamboi_v_f',t,k,s,m,p) + X_v.l('15_Sabari_v_f', t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         ...
                                         - X_v.l('YapeiAg_d_f',  t,k,s,m,p)- X_v.l('DambUr_d_f',   t,k,s,m,p) + X_v.l('NewLoAg_r_f',  t,k,s,m,p) + X_v.l('AsanKAg_r_f',   t,k,s,m,p)- X_v.l('NewLoAg_d_f',    t,k,s,m,p)
                                         - X_v.l('AsanKAg_d_f',  t,k,s,m,p)+ X_v.l('16_Prang_v_f', t,k,s,m,p) - X_v.l('GolgaAg_d_f',  t,k,s,m,p) + X_v.l('BuipeAg_r_f',   t,k,s,m,p)- X_v.l('LibgaAg_d_f',    t,k,s,m,p)
...
*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('DaboAg_u_f',t,k,s,m,p)  = X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',t,k,s,m,p) + X_v.l('14_Bamboi_v_f',t,k,s,m,p) + X_v.l('15_Sabari_v_f',t,k,s,m,p) + X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         ...
                                         - X_v.l('YapeiAg_d_f',  t,k,s,m,p)- X_v.l('DambUr_d_f',   t,k,s,m,p) + X_v.l('NewLoAg_r_f',  t,k,s,m,p) + X_v.l('AsanKAg_r_f',    t,k,s,m,p)- X_v.l('NewLoAg_d_f',   t,k,s,m,p)
                                         - X_v.l('AsanKAg_d_f',  t,k,s,m,p)+ X_v.l('16_Prang_v_f', t,k,s,m,p) - X_v.l('GolgaAg_d_f',  t,k,s,m,p) + X_v.l('BuipeAg_r_f',    t,k,s,m,p)+ X_v.l('Mole_h_f',      t,k,s,m,p)
...
*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('TamaleUr_u_f',t,k,s,m,p)= X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',t,k,s,m,p) + X_v.l('14_Bamboi_v_f',t,k,s,m,p) + X_v.l('15_Sabari_v_f',  t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         ...
                                         - X_v.l('NewLoAg_d_f',  t,k,s,m,p)- X_v.l('AsanKAg_d_f',  t,k,s,m,p) + X_v.l('16_Prang_v_f', t,k,s,m,p) - X_v.l('18_AkosomUp_v_f',t,k,s,m,p)+ X_v.l('Mole_h_f',       t,k,s,m,p)
...
*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('YapeiAg_u_f',t,k,s,m,p) = X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',t,k,s,m,p) + X_v.l('14_Bamboi_v_f',t,k,s,m,p)+ X_v.l('15_Sabari_v_f',t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         ...
                                         - X_v.l('AsanKAg_d_f',  t,k,s,m,p)+ X_v.l('16_Prang_v_f', t,k,s,m,p) + X_v.l('Mo_h_f',       t,k,s,m,p)- X_v.l('GolgaAg_d_f',  t,k,s,m,p)+ X_v.l('BuipeAg_r_f',    t,k,s,m,p)
...
*------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('NewLoAg_u_f',t,k,s,m,p) = X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',t,k,s,m,p) + X_v.l('14_Bamboi_v_f',t,k,s,m,p)+ X_v.l('15_Sabari_v_f',t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         ...
                                         - X_v.l('AsanKAg_d_f',  t,k,s,m,p)+ X_v.l('16_Prang_v_f', t,k,s,m,p) - X_v.l('GolgaAg_d_f',  t,k,s,m,p)+ X_v.l('BuipeAg_r_f',  t,k,s,m,p)+ X_v.l('DaboAg_r_f',     t,k,s,m,p)
                                         - X_v.l('LibgaAg_d_f',  t,k,s,m,p)- X_v.l('TamaleUr_d_f', t,k,s,m,p) + X_v.l('GolgaAg_r_f',  t,k,s,m,p)+ X_v.l('LibgaAg_r_f',  t,k,s,m,p)- X_v.l('BuipeAg_d_f',    t,k,s,m,p)
...
*------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('AsanKAg_u_f',t,k,s,m,p) = X_v.l('Subin_h_f',    t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',t,k,s,m,p) + X_v.l('14_Bamboi_v_f',t,k,s,m,p)+ X_v.l('15_Sabari_v_f',t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         + X_v.l('DipaliAg_r_f', t,k,s,m,p)+ X_v.l('SogoAg_r_f',   t,k,s,m,p) + X_v.l('SavelUr_r_f',  t,k,s,m,p)+ X_v.l('BotangAg_r_f', t,k,s,m,p)+ X_v.l('DaboAg_r_f',     t,k,s,m,p)
                                         + X_v.l('DambUr_r_f',   t,k,s,m,p)- X_v.l('DipaliAg_d_f', t,k,s,m,p) - X_v.l('SogoAg_d_f',   t,k,s,m,p)- X_v.l('SavelUr_d_f',  t,k,s,m,p)- X_v.l('BotangAg_d_f',   t,k,s,m,p)
                                         ...
                                         - X_v.l('YapeiAg_d_f',  t,k,s,m,p)+ X_v.l('16_Prang_v_f', t,k,s,m,p) - X_v.l('GolgaAg_d_f',  t,k,s,m,p)+ X_v.l('BuipeAg_r_f',  t,k,s,m,p)- X_v.l('18_AkosomUp_v_f',t,k,s,m,p)
                                         - X_v.l('LibgaAg_d_f',  t,k,s,m,p)- X_v.l('TamaleUr_d_f', t,k,s,m,p) + X_v.l('GolgaAg_r_f',  t,k,s,m,p)  + X_v.l('LibgaAg_r_f',t,k,s,m,p)- X_v.l('BuipeAg_d_f',    t,k,s,m,p)
                                         - X_v.l('SubinjAg_d_f', t,k,s,m,p)+ X_v.l('SubinjAg_r_f', t,k,s,m,p) + X_v.l('AMATE_rel_f',  t,k,s,m,p)+ X_v.l('SUBIN_rel_f',  t,k,s,m,p)+ X_v.l('Mole_h_f',       t,k,s,m,p)
...
*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('BuipeAg_u_f',t,k,s,m,p) = X_v.l('Subin_h_f',   t,k,s,m,p)+  X_v.l('13_Nawuni_v_f',t,k,s,m,p) + X_v.l('14_Bamboi_v_f',t,k,s,m,p)+ X_v.l('15_Sabari_v_f',t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         + X_v.l('DipaliAg_r_f',t,k,s,m,p)+ X_v.l('SogoAg_r_f',    t,k,s,m,p) + X_v.l('SavelUr_r_f',  t,k,s,m,p)+ X_v.l('BotangAg_r_f', t,k,s,m,p)+ X_v.l('YapeiAg_r_f',    t,k,s,m,p)
                                         + X_v.l('DambUr_r_f',  t,k,s,m,p)- X_v.l('DipaliAg_d_f',  t,k,s,m,p) - X_v.l('SogoAg_d_f',   t,k,s,m,p)- X_v.l('SavelUr_d_f',  t,k,s,m,p)- X_v.l('BotangAg_d_f',   t,k,s,m,p)
                                         - X_v.l('YapeiAg_d_f', t,k,s,m,p)- X_v.l('DambUr_d_f',    t,k,s,m,p) + X_v.l('NewLoAg_r_f',  t,k,s,m,p)+ X_v.l('AsanKAg_r_f',  t,k,s,m,p)- X_v.l('NewLoAg_d_f',    t,k,s,m,p)
                                         - X_v.l('AsanKAg_d_f', t,k,s,m,p)+ X_v.l('16_Prang_v_f',  t,k,s,m,p) - X_v.l('GolgaAg_d_f',  t,k,s,m,p)+ X_v.l('DaboAg_r_f',   t,k,s,m,p)- X_v.l('18_AkosomUp_v_f',t,k,s,m,p)
...
*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('DambUr_u_f',t,k,s,m,p)  = X_v.l('Subin_h_f',   t,k,s,m,p)+ X_v.l('13_Nawuni_v_f',t,k,s,m,p)+ X_v.l('14_Bamboi_v_f',t,k,s,m,p)+ X_v.l('15_Sabari_v_f',t,k,s,m,p)+ X_v.l('17_Ekumdipe_v_f',t,k,s,m,p)
                                         + X_v.l('DipaliAg_r_f',t,k,s,m,p)+ X_v.l('SogoAg_r_f',   t,k,s,m,p)+ X_v.l('LibgaAg_r_f',  t,k,s,m,p)+ X_v.l('DaboAg_r_f',   t,k,s,m,p)+ X_v.l('BuipeAg_r_f',    t,k,s,m,p)
                                         ...
                                         - X_v.l('NewLoAg_d_f', t,k,s,m,p)- X_v.l('AsanKAg_d_f',  t,k,s,m,p)+ X_v.l('16_Prang_v_f', t,k,s,m,p)+ X_v.l('Mo_h_f',       t,k,s,m,p)- X_v.l('18_AkosomUp_v_f',t,k,s,m,p)
...
*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('YendiUr_u_f',t,k,s,m,p) = X_v.l('Daka_h_f',t,k,s,m,p)- X_v.l('17_Ekumdipe_v_f',t,k,s,m,p) -X_v.l('YendiUr_u_f',t,k,s,m,p)+ eps;
*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
...
*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('TanosoAg_u_f',t,k,s,m,p)  =     X_v.l('Pru_h_f',t,k,s,m,p)      - X_v.l('16_Prang_v_f',t,k,s,m,p)    - X_v.l('AkumaAg_d_f',t,k,s,m,p)
...
*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
check_wat_use_p('AkumaAg_u_f',t,k,s,m,p)  =          X_v.l('Pru_h_f',t,k,s,m,p)      - X_v.l('16_Prang_v_f',t,k,s,m,p)    - X_v.l('TanosoAg_d_f',t,k,s,m,p)
